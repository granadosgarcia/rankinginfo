...
<?php if(!empty($row['img_cedula_profesional'])) {?>
										<td><label>Cedula Profesional</label>
											 <a class="imagengrande" href="<?php htmlentities($row['img_cedula_profesional'])?>" <img height="100px" width="150px" src="<?php echo htmlentities($row['img_cedula_profesional'])?>"></td>
<?php } else { ?>
