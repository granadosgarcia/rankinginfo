...
<?php } } ?>
				...
				<br>
					...
					<p class="lab"> Telefono </p>
		
					<input type="text" name="telefono_evaluador"   id="telefono_evaluador"><br>
					
					<p class="lab"> Dirección Completa </p>
		
					<input type="text" name="direccion_evaluador"   id="direccion_evaluador"><br>
